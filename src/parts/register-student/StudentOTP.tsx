...
const StudentOtp: React.FC<PropInfo> = ({ userData, changeStage }) => {
    ...
    const handleSubmitOTP = (e: React.FormEvent) => {
        ...
        setTimeout(()=>{
          setStatus(false);
                console.log('OTP valid:', userData, otp);
  ...
  return (
    ...
    <div className="flex flex-col mt-4 space-y-4 lg:mt-1 lg:space-y-7">
      ...
      <div className="text-[14px] font-normal  text-center p-3">
        {
            time === 0 ? <>
                <span className="text-red-primary underline hover:text-blue-primary cursor-pointer" onClick={resendOTP}>Send OTP again</span>
            </> : <>
